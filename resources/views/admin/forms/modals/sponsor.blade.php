<div class="modal fade dd-modal" id="create-sponsor-modal">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                            aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">Add a new Sponsor</h4>
            </div>
            <form action="/admin/associates" method="POST" class="modal-form dd-form form-horizontal">
